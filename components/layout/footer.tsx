...
const socialLinks = [
    ...
    { icon: Instagram, href: "https://www.instagram.com/kehaeskepedesignandbuild?igsh=MWViMWh6cnRiczludQ==", label: "Instagram" },
    { icon: MapPin, href: "https://maps.app.goo.gl/xhuiKiiySgGYGP7H9", label: "Location" },
    { icon: TikTokIcon, href: "https://www.tiktok.com/@kehaeskepedesignandbuild?_r=1&_t=ZM-92dl6mM17W4", label: "TikTok" },
];
