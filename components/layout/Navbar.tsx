...
function NavLink({ href, children, className, onClick }: NavLinkProps) {
	const baseStyles =
		"relative overflow-hidden py-1 font-bold uppercase text-xs tracking-[0.25em]";
	...
	return (
		...
		>
			...
			<motion.span
				className="absolute left-0 top-full inline-block opacity-60"
				variants={{
					idle: { y: 0 },
					hover: { y: "-100%" },
				}}
		...
		<>
			...
			<nav className="fixed w-full px-6 md:px-12 py-6 flex justify-between items-center z-1000 text-foreground  backdrop-blur-lg">
				...
				<div className="hidden md:flex items-center gap-10">
					...
					<div className="flex items-center gap-6 border-l border-primary/10 pl-6 ml-2">
						<div className="font-mono opacity-60 flex items-center gap-2 text-[10px] tracking-normal">
							<Phone size={12} />
							{phone}
						</div>
					</div>
